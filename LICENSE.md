...
| --- | --- |
| Editor product | [AGPL-3.0-only](packages/editor/LICENSE), [Blender-derived GPL material](packages/editor/LICENSE-BLENDER), [MIT MCP notice](packages/editor/LICENSE-MCP), [NOTICE](packages/editor/NOTICE) |
...
`packages/editor/workbench/extensions/theme-blender/`; Inter's OFL notice also
...
Bundled code retains additional notices in the [product](packages/editor/BUNDLED_NOTICES),
