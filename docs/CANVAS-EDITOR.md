...
pivot snapping to its node's sides and centre, and Configure Snap's fields.

1. Right-click: Godot's RMB adds a node at the point and Alt+RMB lists the nodes there; ours lists on
