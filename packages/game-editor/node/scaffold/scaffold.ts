...
function rewritePackageJson(
  ...
  // `@volter/editor-live` and `@volter/editor-sdk`: devDependencies the
  // template declares at a range. Rewritten to this distribution's own version
  // like every runtime package: `@volter/editor-live` depends on
  // `@volter/editor-sdk`, and capability source (`src/tools/*.tool.ts`, editor
  // contributions) imports `@volter/editor-sdk` directly, so they are declared
  // as a pair.
  for (const name of ['@volter/editor-live', '@volter/editor-sdk'] as const) {
