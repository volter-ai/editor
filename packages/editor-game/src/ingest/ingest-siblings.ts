...
import { withStoreSelection } from '@editor/authoring/mounted-authoring';
...
import { createLiveCanvasWriteTarget } from '@editor/authoring/pixi-live-write-target';
...
import { ReactRootAuthoringAdapter, walkOidTree } from '@vgai/dom/react-world-authoring-adapter';
...
import { createPhysicsAdapter2D } from '@vgai/game-runtime/pixi/system-adapters';
...
import { structuralThree } from '@vgai/threejs/authoring/three-authoring-adapter';
