...
export const GODOT4_GLOBAL_ENUMS = Object.freeze({
  ClockDirection: Object.freeze({
    CLOCKWISE: 0,
    COUNTERCLOCKWISE: 1,
  } as const),
  ...
  PropertyUsageFlags: Object.freeze({
  ...
  'Variant.Operator': Object.freeze({
    OP_EQUAL: 0,
    OP_NOT_EQUAL: 1,
    OP_LESS: 2,
    OP_LESS_EQUAL: 3,
  ...
  VerticalAlignment: Object.freeze({
