 ...
 * (`physics-server-3d.ts`) followed by moving the node by the travel. No axis is locked (the axis
 * lock properties are not bound).
 */

import type { Object3D } from 'three';
import { godot_collision_object_exceptions, godot_collision_object_state } from './collision-object-3d';
