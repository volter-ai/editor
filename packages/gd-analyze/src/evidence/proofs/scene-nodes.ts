/** The scene-node authority's proof: official Godot's instantiated nodes versus the planned tree. */
...
} from '../../translate/data/scene-document-plan';
import {
  GODOT_SCENE_NODE_IMPLEMENTATION_FILES,
  godotSceneNodeAuthority,
} from '../../translate/data/scene-node-authority-data';
...
export function measureSceneNodeProof(tools: GodotProofTools): readonly GodotProofMeasurement[] {
