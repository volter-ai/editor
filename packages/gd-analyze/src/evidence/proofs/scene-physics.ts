...
/**
 * The emitted project's packages as gd-analyze resolves them (its own `node_modules` first, as its
 * package.json pins what compat declares, e.g. Rapier 0.14), else the monorepo's.
 */
