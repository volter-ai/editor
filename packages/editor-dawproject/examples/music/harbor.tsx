...
export default function Harbor() {
  return (
    <Project>
      ...
      <Track name="Clarinet">
        <Channel volume={-9} pan={-0.25}>
          <Device plugin="soundfont" name="Clarinet" params={{ bank: BANK, program: 71 }} />
      ...
      <Track name="Horn">
        <Channel volume={-10} pan={0.3}>
          <Device plugin="soundfont" name="French Horn" params={{ bank: BANK, program: 60 }} />
      ...
      <Track name="Harp">
        <Channel volume={-10} pan={-0.35}>
          <Device plugin="soundfont" name="Harp" params={{ bank: BANK, program: 46 }} />
      ...
      <Track name="Strings">
        <Channel volume={-13} pan={0}>
          <Device plugin="soundfont" name="Strings" params={{ bank: BANK, program: 48 }} />
      ...
      <Track name="Cello">
        <Channel volume={-7} pan={0.2}>
          <Device plugin="soundfont" name="Cello" params={{ bank: BANK, program: 42 }} />
      ...
      <Track name="Contrabass">
        <Channel volume={-11} pan={0.25}>
          <Device plugin="soundfont" name="Contrabass" params={{ bank: BANK, program: 43 }} />
      ...
      <Track name="Master">
        <Channel role="master">
          <Device plugin="compressor" params={{ threshold: -20, ratio: 1.5, attack: 40, release: 300, knee: 8, makeup: 0 }} />
