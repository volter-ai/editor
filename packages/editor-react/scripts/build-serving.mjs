...
// node_modules, so it ships built: the plugin and the declared-prop worker, side by side.
...
await build({ ...common, entryPoints: ['serving/component-prop-worker.ts'], outfile: 'dist-node/component-prop-worker.mjs' });
