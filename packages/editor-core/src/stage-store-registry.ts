...
const stores = new Map<string, { store: EditorShellStore }>();
...
export function registerStageStore(documentId: string, store: EditorShellStore): () => void {
...
export function stageStore(documentId: string | null): EditorShellStore | null {
