...
import { documentStageSession } from '@volter/editor-sdk/kit/document-stage-sessions';
import {
...
export function focusedStageContext(store: ShellStore): StageContext {
 ...
 */
export function focusedStageStore(shell: ShellStore): ShellStore {
