...
const EditorContext = createHmrStableReactContext<EditorRuntime | null>(
  // Vite's HMR data when a dev server serves this module; the SDK carries no bundler types.
  (import.meta as ImportMeta & { hot?: { data: Record<string, unknown> } }).hot?.data,
  'EditorContext',
  null,
);
